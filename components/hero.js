            ...
            <div className="flex-1 rounded-lg bg-gray-white flex flex-row py-8 px-[62px] box-border items-center justify-between max-w-[1400px] md:w-[300px] md:flex-col md:gap-[20px] md:items-start md:justify-start md:ml-[auto] md:mr-[auto]">
              <div className="w-[137px] flex flex-col items-start justify-start gap-[16px] text-center">
                ...
                <Dropdown
                  overlay={
                    <Menu>
                      {[{ value: "New York" }, { value: "London" }].map(
                        (option, index) => (
                          <Menu.Item key={index}>
              ...
              <button
                className="cursor-pointer [border:none] py-3 px-6 bg-primary-500 rounded w-[102px] flex flex-row box-border items-center justify-center hover:bg-steelblue hover:items-end hover:justify-end hover:box-border hover:cursor-ne-resize hover:[transition:0.3s] hover:border-[1px] hover:border-solid hover:border-black"
